...
- [ ] **Rich output formats: Marp + matplotlib** 🟢/🟡
  ...
  — Marp slide decks (easy — markdown with Marp frontmatter, auto-filed to `wiki/analyses/`) 🟢
  — matplotlib charts (medium — Python + chart code generated by Claude, saved as `.png`) 🟡
