...
1. `_hot.md` — active context, ~500 tokens. Resolves ~70% of queries.
2. `index.md` — full content catalog. Navigate to specific pages.
3. Individual `wiki/` pages — deep reads.
4. `qmd query "<question>"` — semantic search fallback.
Never read more than 5 wiki pages per query.
